...
async function GET(request, { params }) {
    try {
        ...
        const [turns, playerInfoMap] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Turn$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Turn"].find({
                battleId: id
            }).sort({
                turnNumber: 1
            }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95b68ebb._.js.map