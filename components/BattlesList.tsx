      ...
      {filteredBattles.length === 0 ? (
        ...
        <div className="grid gap-4">
          {filteredBattles.map((battle) => (
            ...
            >
              <Card className="hover:border-primary/50 transition-colors cursor-pointer border-0 shadow-none bg-transparent">
                <CardContent className="flex items-center justify-between gap-4 p-6">
                  <div className="flex items-center gap-4 min-w-0">
                    <div className="w-12 h-12 rounded-xl bg-muted flex items-center justify-center shrink-0 border-0 shadow-none">
