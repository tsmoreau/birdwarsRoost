                  ...
                  <div className="flex items-center gap-4 min-w-0 w-full">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[12px] font-bold uppercase tracking-tight text-muted-foreground flex items-center gap-2 mb-0.5">
                        <span>{battle.currentPlayerIndex === 0 && battle.status === 'active' && <span className="opacity-40 mr-1">»</span>}{battle.player1DisplayName}</span>
                        <span className="text-[10px] opacity-40">VS</span>
                        <span>{battle.currentPlayerIndex === 1 && battle.status === 'active' && <span className="opacity-40 mr-1">»</span>}{battle.player2DisplayName ? `${battle.player2DisplayName}` : 'WAITING...'}</span>
                      </p>
