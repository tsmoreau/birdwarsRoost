                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-sm mb-2">
                      <span className="font-bold uppercase">
                        {battle.currentPlayerIndex === 0 && battle.status === 'active' && <span className="text-muted-foreground mr-1 inline-block -translate-y-[1px]">▶</span>}
                        {battle.player1DisplayName}
                      </span>
                      <span className="text-muted-foreground">vs</span>
                      <span className="font-bold uppercase">
                        {battle.currentPlayerIndex === 1 && battle.status === 'active' && <span className="text-muted-foreground mr-1 inline-block -translate-y-[1px]">▶</span>}
